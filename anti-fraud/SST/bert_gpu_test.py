...
def get_df(filepath="../datasets/weibo_senti_100k.csv",batch_size = 32,check_data=False):
    ...
    df = pd.read_csv('weibo_senti_100k_sentence.csv')
...
if __name__ == '__main__':
    train_loader,vali_loader,test_loader=get_df(filepath=args.filepath,batch_size=args.batchsize,check_data=False)
